...
class KarzaInternalStatusCodes(Enum):
    ...
    HTTP_102_INVALID_ID_NUMBER_OR_COMBINATION_OF_INPUTS = {'status': 102, 'message':'Invalid ID number or combination of inputs'}
    ...
    @staticmethod
    def list():
        lst = list(map(lambda status_name: status_name.value, KarzaInternalStatusCodes))
        return lst
